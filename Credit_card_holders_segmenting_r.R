rm(list = ls())
setwd("C:/Users/HP/Downloads/EDWISER/Project 1")
...
credit$BALANCE_FREQUENCY[credit$BALANCE_FREQUENCY>1.351079]<-1.351079
credit$PURCHASES[credit$PURCHASES>5276.46]<-5276.46
credit$Monthly_Avg_PURCHASES[credit$Monthly_Avg_PURCHASES>800.03] <- 800.03
credit$ONEOFF_PURCHASES[credit$ONEOFF_PURCHASES>3912.213]<-3912.213
credit$INSTALLMENTS_PURCHASES[credit$INSTALLMENTS_PURCHASES>2219.744]<-2219.744
credit$CASH_ADVANCE[credit$CASH_ADVANCE>5173.199]<-5173.199
credit$Monthly_CASH_ADVANCE[credit$Monthly_CASH_ADVANCE>2558.53] <- 2558.53
credit$PURCHASES_FREQUENCY[credit$PURCHASES_FREQUENCY>1.293092]<-1.293092
credit$ONEOFF_PURCHASES_FREQUENCY[credit$ONEOFF_PURCHASES_FREQUENCY>0.7991298]<-0.7991298
credit$PURCHASES_INSTALLMENTS_FREQUENCY[credit$PURCHASES_INSTALLMENTS_FREQUENCY>1.159333]<-1.159333
credit$CASH_ADVANCE_FREQUENCY[credit$CASH_ADVANCE_FREQUENCY>0.535387]<-0.535387
credit$CASH_ADVANCE_TRX[credit$CASH_ADVANCE_TRX>16.89812]<-16.89812
credit$PURCHASES_TRX[credit$PURCHASES_TRX>64.42513]<-64.42513
credit$CREDIT_LIMIT[credit$CREDIT_LIMIT>11772.08]<-11772.08
credit$LIMIT_USAGE[credit$LIMIT_USAGE>1.168371] <- 1.168371
credit$PAYMENTS[credit$PAYMENTS>7523.27]<-7523.27          
credit$MINIMUM_PAYMENTS[credit$MINIMUM_PAYMENTS>5609.100]<-5609.100
...
credit$MINIMUM_PAYMENTS[which(is.na(credit$MINIMUM_PAYMENTS))] <- 864.2065423
credit$CREDIT_LIMIT[which(is.na(credit$CREDIT_LIMIT))] <- 4494.4494504
